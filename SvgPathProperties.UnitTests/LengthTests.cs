...
namespace SvgPathProperties.UnitTests
{
    public class LengthTests
    {
        ...
        {
            var properties = new LinearProperties(0, 0, 10, 0);
            Assert.Equal(10, properties.GetTotalLength());
        }
        ...
        public void TestingTheLineTo()
        {
            ...
            Assert.Equal(20, properties.GetTotalLength());
        ...
        public void TestingCubicBezier()
        {
            ...
            Assert.True(Helpers.InDelta(properties.GetTotalLength(), 213.8, 0.1));
            ...
            Assert.True(Helpers.InDelta(properties.GetTotalLength(), 475.746, 0.1));
            ...
            Assert.True(Helpers.InDelta(properties.GetTotalLength(), 327.9618, 0.1));
        ...
        public void TestingQuadraticBezier()
        {
            ...
            Assert.True(Helpers.InDelta(properties.GetTotalLength(), 487.77, 0.1));

            properties = new SVGPathProperties("M200,300 q200,-250 400,0");
            Assert.True(Helpers.InDelta(properties.GetTotalLength(), 487.77, 0.1));

            properties = new SVGPathProperties("M0,100 Q50,-50 100,100 T200,100");
            Assert.True(Helpers.InDelta(properties.GetTotalLength(), 376.84, 0.1));
            ...
            Assert.True(Helpers.InDelta(properties.GetTotalLength(), 565.26, 0.1));

            properties = new SVGPathProperties("M0, 100 T200, 100");
            Assert.True(Helpers.InDelta(properties.GetTotalLength(), 200, 0.1));

            properties = new SVGPathProperties("M0,100 t200,100");
            Assert.True(Helpers.InDelta(properties.GetTotalLength(), 223.606, 0.1));
        }
        ...
        public void TestingArcs()
        {
            ...
            Assert.True(Helpers.InDelta(properties.GetTotalLength(), 157.1, 0.1));

            properties = new SVGPathProperties("M50,20A50,50,0,0,0,150,20Z");
            Assert.True(Helpers.InDelta(properties.GetTotalLength(), 257.1, 0.1));

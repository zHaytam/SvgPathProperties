...
namespace SvgPathProperties.UnitTests
{
    public class BezierTests
    {
        ...
        {
            var curve = new BezierCommand(200, 300, 400, 50, 600, 300, null, null);
        ...
        {
            var curve = new BezierCommand(200, 200, 275, 100, 575, 100, 500, 200);
        ...
        {
            var curve = new BezierCommand(640.48, 1285.21, 642.39, 644.73, 642.39, 644.73, null, null);
